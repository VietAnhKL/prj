  ...
  <div class="row d-flex">
   ...
   <div class="col-md-6 ftco-animate makereservation p-4 p-md-5">
     <div class="heading-section ftco-animate mb-5">
      ...
      <p>Tempor exercitation deserunt aliquip magna ipsum ullamco cupidatat eiusmod laborum elit do veniam minim.Tempor exercitation deserunt aliquip magna ipsum ullamco cupidatat eiusmod laborum elit do veniam minim.
      </p>
    ...
    <div class="carousel-testimony owl-carousel ftco-owl">
      <div class="item">
        <div class="testimony-wrap text-center">
          <div class="text p-3">
            <p class="mb-4">Tempor exercitation deserunt aliquip magna ipsum ullamco cupidatat eiusmod laborum elit do veniam minim.</p>
