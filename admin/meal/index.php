...
$sql_so_tin_tuc = "select count(*) from meal
 ";
...
<div style="border-top:#09F solid 1px; margin:15px">
    ...
    <h3 style="color:#fff; font-weight:bold">Meal</h3>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td style="background-color: #ffffff;" ><?php echo $each['category_name'] ?></td>
                    <td style="background-color: #ffffff; text-align:justify; padding:5px"><?php echo $each['description'] ?></td>
                    <td style="background-color: #ffffff; text-align:justify; padding:5px"><?php echo $each['description_detail'] ?></td>
                    <td style="background-color: #ffffff;" >$<?php echo $each['price'] ?></td>
                    <!-- <td>25,000</td> -->
                    <td style="background-color: #ffffff;" ><img src="photos/<?php echo $each['photo'] ?>" width="100px" height="100px"></td>
                    <td style="background-color: #ffffff;" ><a href="update_meal.php?id=<?php echo $each['id'] ?>">Edit</a></td>
