...
$sql_so_tin_tuc = "select count(*) from booking
";
...
<div style="border-top:#09F solid 1px; margin:15px">
    ...
    <h3 style="color:#fff; font-weight:bold">Type of Meal</h3>
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td style="background-color: #ffffff;" align="center"><?php echo $each['email'] ?></td>
                        <td style="background-color: #ffffff;" align="justify" style="padding:5px"><?php echo $each['phone'] ?></td>
           
                        <td style="background-color: #ffffff;" align="center"><?php echo $each['check_in'] ?></td>
                        <td style="background-color: #ffffff;" align="center"><?php echo $each['time'] ?></td>
                        ...
                        <button class="btn btn-primary" type="button" onclick="myFunction()">Change Status</button>
                    </td>
                    <script>
function myFunction() {
